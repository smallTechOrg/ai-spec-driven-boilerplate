...
Record sign-off in `logs/PLAN.md` `## Progress Tracker` + `## Phase Acceptance` and in the
session report. You do NOT edit `src/` to make tests pass — that is the executor's job
