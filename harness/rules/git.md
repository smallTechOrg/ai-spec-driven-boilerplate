...
- Before writing any application code, create a feature branch with a datestamp suffix to ensure uniqueness across repeated builds: `git checkout -b feature/<slug>-$(date +%m%d-%H%M)-v0.1`
